...
def channels_graph(g, r_c):
    ...
    Args:
        ...
        It should be constructed the following way:
            1 - The key "in" is used for the network input
            2 - The keys are 'str(i)' where 'i=1, 2, 3...' is the layer number
            3 - The key "out" corresponds to the output of the vvs_network
            4 - The values 'g[str(i)]' are lists '[j]' where the layer 'g[str(j)]'
